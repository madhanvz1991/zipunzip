...
import static com.zip.zipunzip.util.InternalZipConstants.ZIP_FILE_SEPARATOR;
...
public class FileUtils {
  ...
  public static void setFileLastModifiedTime(Path file, long lastModifiedTime) {
    ...
    try {
      Files.setLastModifiedTime(file, FileTime.fromMillis(ZipUtil.dosToJavaTme(lastModifiedTime)));
    } catch (Exception e) {
      // Ignore
    }
  }
  ...
  public static void setFileLastModifiedTimeWithoutNio(File file, long lastModifiedTime) {
    file.setLastModified(ZipUtil.dosToJavaTme(lastModifiedTime));
  }
  ...
  public static String getRelativeFileName(String fileToAdd, ZipParameters zipParameters) throws ZipException {
    ...
    if (ZipUtil.isStringNotNullAndNotEmpty(rootFolderNameInZip)) {
